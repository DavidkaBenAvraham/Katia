...
class Log(Ini):
    ...
    def __init__(self):
        ...
        self.logfile_path = str(f'''{self.path}/../LOGS/{self.get_now()}.html''')
    ...
    def print(self, log = object, prn_type="simple"):
        '''
        Вывод в консоль
    ...
    def log_to_file(self ,  log = object):
        '''
        Запись в файл
        '''
        open(self.logfile_path  , mode = 'a' ,encoding = 'UTF-8').write(str(log)).close()

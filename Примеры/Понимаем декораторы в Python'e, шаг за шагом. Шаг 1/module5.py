...
def my_shiny_new_decorator(a_function_to_decorate):
    ...
    def the_wrapper_around_the_original_function():
        ...
        self.log("Я - код, который отработает до вызова функции")
        ...
        # оригинальной функции
        self.log("А я - код, срабатывающий после")
...
def a_stand_alone_function():
    self.log("Я простая одинокая функция, ты ведь не посмеешь меня изменять?..")
...
a_stand_alone_function, вместо неё вызывалась a_stand_alone_function_decorated. 

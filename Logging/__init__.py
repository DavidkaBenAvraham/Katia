...
class Log():
    ...
    def __init__(self,  **kwards):
        ...
        '''
        self.path_root = Ini().path_root
        self.logfile = str(f'''{self.path_root}\\Logging\\LOGS\\{self.random_id}.html''')
    ...
    def screenshot(self , log = object):
        ...
        path = self.path_root['log_dir'] + '/' + filename
        print("Saving " + path)
    ...
    def load(file , attrs='r'):
        ...
        self.path_root}\\Logging\\LOGS\\
        '''
        logfile = open(f'''{self.path_root}\\Logging\\LOGS\\{file}'''  , mode = 'w' ,encoding = 'UTF-8')
        return logfile.read()
